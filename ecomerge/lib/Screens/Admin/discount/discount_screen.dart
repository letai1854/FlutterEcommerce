...
class _DiscountScreenState extends State<DiscountScreen> {
  ...
  List<Map<String, dynamic>> get _paginatedData {
    ...
    final endIndex = min(startIndex + _rowsPerPage, _discountData.length);
    
    if (startIndex >= _discountData.length) return [];
    return _discountData.sublist(startIndex, endIndex);
  }
  
  // Tính số trang dựa trên dữ liệu và số hàng mỗi trang
  int get _pageCount => (_discountData.length / _rowsPerPage).ceil();
  ...
  final List<Map<String, dynamic>> _discountData = List.generate(
      25,
      (index) => {
            'code': 'DISCOUNT${index + 1}',
            'description': 'Giảm ${index + 1}%',
            'value': '${index + 1}%',
            'expiry_date': '2025-12-31',
          });

  late DiscountDataSource _discountDataSource;

  @override
  void initState() {
    super.initState();
    _discountDataSource = DiscountDataSource(_discountData);
  }
      ...
      children: [
        ...
        SizedBox(
          ...
          child: Wrap(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  print('Thêm mã giảm giá Pressed');
                },
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            final discount = _paginatedData[index];
            return Column(
              children: [
                Card(
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              Text(
                'Hiển thị ${_paginatedData.isEmpty ? 0 : (_currentPage * _rowsPerPage) + 1} - ${(_currentPage * _rowsPerPage) + _paginatedData.length} trên ${_discountData.length}',
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: SizedBox(
                      ...
                      child: PaginatedDataTable(
                        key: ValueKey(_discountData.length),
                        columnSpacing: 20,
                        horizontalMargin: 10,
                        columns: const [
...
class DiscountDataSource extends DataTableSource {
  final List<Map<String, dynamic>> _data;

  DiscountDataSource(this._data);
