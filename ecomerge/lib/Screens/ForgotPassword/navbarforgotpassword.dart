...
class NavbarForgotPassword extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      title: Padding(
        // Padding cho toàn bộ nội dung title
            ...
            MouseRegion(
              ...
              child: GestureDetector(
                onTap: () => Navigator.pushReplacementNamed(
                    context, '/'), // Dùng pushReplacementNamed nếu về home
                child: Row(
                  children: [
                    Image.asset(
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color:
                            const Color.fromARGB(255, 255, 255, 255), // Màu chữ
                      ),
                    ),
                  ],
                ),
  ...
  Size get preferredSize =>
      Size.fromHeight(60.0); // Chiều cao AppBar chuẩn, bạn có thể thay đổi
}
//commit
