    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget loginFormWidget = LoginForm(
          ...
          togglePasswordVisibility: _togglePasswordVisibility, // Truyền hàm toggle visibility
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
             ...
             SizedBox( // Bọc phần body còn lại trong SizedBox để đảm bảo chiều cao
              height: MediaQuery.of(context).size.height - 80, // Trừ chiều cao navbar
              child: Container(
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          constraints: const BoxConstraints( // Sử dụng const
                            maxHeight: 400, // Có thể điều chỉnh max/minHeight
                            minHeight: 350,
                          ),
                          child: loginFormWidget, // Sử dụng widget đã tạo
                        ),
