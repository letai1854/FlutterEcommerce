...
class _CartmobileState extends State<Cartmobile> {
  ...
  Widget build(BuildContext context) {
    return NavbarFixmobile(
      body: BodyCartMobile(), // Truyền body vào NavbarFixmobile
    );
  }
}
...
class BodyCartMobile extends StatefulWidget {
  const BodyCartMobile({Key? key}) : super(key: key);

  @override
  State<BodyCartMobile> createState() => _BodyCartDesktopState();
}

class _BodyCartDesktopState extends State<BodyCartMobile> {
