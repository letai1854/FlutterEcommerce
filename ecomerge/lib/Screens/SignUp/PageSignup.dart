...
class _PageSignupState extends State<PageSignup> {
  ...
  final TextEditingController _addressController = TextEditingController(); // Địa chỉ chi tiết (ví dụ: số nhà, tên đường)
  ...
  void _handleLocationSelected(String provinceName, String districtName, String wardName) {
  ...
  String _getFullAddressString() {
    ...
    final locationParts = [_selectedWardName, _selectedDistrictName, _selectedProvinceName]
  ...
  Future<void> _handleSignup() async {
    ...
    if (_emailController.text.trim().isEmpty ||
        ...
        _selectedProvinceName.isEmpty || // Location validation (check if NAME is empty)
        _selectedDistrictName.isEmpty ||
        _selectedWardName.isEmpty
        ) {
      setState(() {
        _errorMessage = 'Vui lòng điền đầy đủ thông tin, bao gồm cả địa chỉ chi tiết và khu vực (Tỉnh/Thành phố, Quận/Huyện, Phường/Xã).';
      });
      // Consider focusing the first empty field for better UX
       if (_emailController.text.trim().isEmpty) _emailFocusNode.requestFocus();
       else if (_nameController.text.trim().isEmpty) _nameFocusNode.requestFocus();
       else if (_addressController.text.trim().isEmpty) _addressFocusNode.requestFocus();
       // Cannot easily focus LocationSelection, but _addressFocusNode is related
       else if (_passwordController.text.isEmpty) _passwordFocusNode.requestFocus();
       else if (_rePasswordController.text.isEmpty) _rePasswordFocusNode.requestFocus();
    ...
    if (_passwordController.text != _rePasswordController.text) {
      ...
      _rePasswordFocusNode.requestFocus(); // Focus re-password field on mismatch
      return;
    }
    ...
    try {
       ...
       success = await _userService.registerUser(
        ...
        address: _getFullAddressString(), // Pass the combined address string with NAMES
      );
      ...
      if (mounted) {
         if (success == true) {
            ...
            setState(() {
               _errorMessage = 'Đăng ký thất bại. Vui lòng kiểm tra lại thông tin hoặc thử lại sau.';
      ...
      if (mounted) {
         ...
         if (e is Exception) { // Nếu là Exception thông thường, có thể lấy message
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget signFormWidget = SignForm(
          ...
          addressController: _addressController, // Pass detailed address controller
          ...
          togglePasswordVisibility: _togglePasswordVisibility, // Truyền hàm toggle password visibility
          toggleRePasswordVisibility: _toggleRePasswordVisibility, // Truyền hàm toggle re-password visibility
      ...
      body: Stack(
        children: [
                  ...
                  child: Padding(
                    ...
                    child: GestureDetector(
                      ...
                      child: Row(
                        ...
                        children: [
                          Image.asset(
                            'assets/logoS.jpg', // Đảm bảo đường dẫn đúng
                            height: 80,
                            width: 80,
                            fit: BoxFit.contain,
                          ),
          ...
          return Scaffold(
            ...
            appBar: const PreferredSize( // Sử dụng const
              preferredSize: Size.fromHeight(80),
              child: Navbar(),
            ),
            body: SizedBox(
              height: MediaQuery.of(context).size.height, // Sử dụng MediaQuery để lấy chiều cao
              child: SingleChildScrollView(
                child: Column( // Loại bỏ LayoutBuilder không cần thiết ở đây
                  children: [
            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    child: Container(
                      decoration: const BoxDecoration( // Sử dụng const
                            ...
                            child: Container(
                              decoration: const BoxDecoration( // Sử dụng const
                                image: DecorationImage(
                                  image: AssetImage('assets/banner.jpg'), // Đảm bảo đường dẫn đúng
                          ...
                          Expanded(
                            ...
                            child: Container(
                              ...
                              child: Container(
                                ...
                                constraints: const BoxConstraints( // Sử dụng const
                                  maxHeight: 510,
                                  minHeight: 350,
                                ),
                                child: signFormWidget, // Sử dụng widget đã tạo
