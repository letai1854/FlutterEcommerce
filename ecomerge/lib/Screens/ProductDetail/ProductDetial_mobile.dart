...
import 'package:e_commerce_app/Screens/ProductDetail/ProductDetial_Desktop.dart';
...
class ProductdetailMobile extends StatefulWidget {
  const ProductdetailMobile({Key? key}) : super(key: key);
...
class _ProductdetailMobileState extends State<ProductdetailMobile> {
  ...
  Widget build(BuildContext context) {
    return NavbarFixmobile(
      body: ProductDetialInfo(), // Truyền body vào NavbarFixmobile
    );
  }
}
